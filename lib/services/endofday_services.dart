...
class EndofdayServices {
  Future<EndOfDayData> getListDeliveryForEndOfDay(DateTime deliveryDate) async {
    ...
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection(DELIVERY_COLLECTION_REF)
    ...
    for (var doc in snapshot.docs) { 
      ...
      endofday.totaldeliveredamount += data[DeliveryModelString.cashAmount] +data[DeliveryModelString.onlineAmount] + data[DeliveryModelString.creditAmount];
