...
class ExpensesService {
  ...
  ExpensesService(){
    _expensesRef = _firestore.collection(EXPENSES_COLLECTION_REF).withConverter<Expenses>(
  ...
  Future<double?> getTotalExpensesForEndOfDay(DateTime expenseDate) async {
    ...
    try {
      ...
      AggregateQuerySnapshot snapshot = await query.aggregate(sum('expenseAmount')).get();
      ...
      print("Error calculating total expense amount for end of day: $e");
      return null;
    }
  }
