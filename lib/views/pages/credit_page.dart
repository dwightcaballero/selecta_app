...
class _CreditPageState extends State<CreditPage> {
  ...
  void initState() {
    ...
    listStatus.add(DropdownMenuEntry(value: CreditStatus.unpaid, label: CreditStatus.unpaid));
    listStatus.add(DropdownMenuEntry(value: CreditStatus.paid, label: CreditStatus.paid));
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  KForms.textTitle('Hapi Store'), Spacer(),
              ...
              Row(
                children: [
                  KForms.textTitle('Credit Amount'), Spacer(),
              ...
              Row(
                children: [
                  KForms.textTitle('Credit Date'), Spacer(),
                  KForms.textDescriptionTimestampDateOnly(widget.delivery.deliveryDate!),
                ],
              ),
  ...
  void onUpdate(){
    ...
    ShowMessage.success(context, 'Successfully updated the delivery record!\n[${updatedDelivery.storeName}]');
