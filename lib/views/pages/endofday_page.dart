...
import 'package:flutter_app/models/endofday.dart';
...
class _EndofdayPageState extends State<EndofdayPage> {
  ...
  EndOfDayData endOfDayData = EndOfDayData.empty();
          ...
          child: Column(
            ...
            children: [
              ...
              KForms.lefRightLabel('Total Delivered Amount : ', Helperfunctions.formatDoubleAmountForDisplay(endOfDayData.totaldeliveredamount)),
                  ...
                  KForms.lefRightLabel('Credit : ', Helperfunctions.formatDoubleAmountForDisplay(endOfDayData.creditamount), withLeftIndent: true, rightLabelColor: Colors.orange),
              KForms.lefRightLabel('Total Returned Amount : ', Helperfunctions.formatDoubleAmountForDisplay(endOfDayData.returnedAmount), rightLabelColor: Colors.red),
              KForms.lefRightLabel('Total Bad Order Amount : ', Helperfunctions.formatDoubleAmountForDisplay(endOfDayData.badorderAmount), rightLabelColor: Colors.red),
              KForms.lefRightLabel('Total Expense Amount : ', Helperfunctions.formatDoubleAmountForDisplay(endOfDayData.expenseAmount), rightLabelColor: Colors.red),
              ...
              if (endOfDayData.actualcashonhand != 0)...[
                ...
                KForms.lefRightLabel('Discrepancy : ', Helperfunctions.formatDoubleAmountForDisplay(endOfDayData.discrepancy), rightLabelColor: Colors.red),
  ...
  void validateBeforeBreakdown() async {
    if (endOfDayData.pendingstatus > 0){
      ...
      await Navigator.push(context, MaterialPageRoute(builder: (context) => BreakdownPage(breakdown: breakdown!, breakdownID: breakdownID,)));
      fetchInitialData();
    }
  }
}