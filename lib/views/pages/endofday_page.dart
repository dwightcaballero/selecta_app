...
import 'package:flutter_app/dto/endofday.dart';
...
class _EndofdayPageState extends State<EndofdayPage> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    KForms.lefRightLabel(
                      ...
                      endOfDayData.totaldelivery.toString(),
                    ),
                    KForms.lefRightLabel(
                      'Pending : ',
                      endOfDayData.pendingstatus.toString(),
                      withLeftIndent: true,
                    ),
                    KForms.lefRightLabel(
                      'Delivered : ',
                      endOfDayData.deliveredstatus.toString(),
                      withLeftIndent: true,
                    ),
                    KForms.lefRightLabel(
                      'Returned : ',
                      endOfDayData.returnedstatus.toString(),
                      withLeftIndent: true,
                    ),
                    ...
                    KForms.lefRightLabel(
                      ...
                      Helperfunctions.formatDoubleAmountForDisplay(
                        endOfDayData.totalorderamount,
                      ),
                    ),
                    KForms.lefRightLabel(
                      'Total Delivered Amount : ',
                      Helperfunctions.formatDoubleAmountForDisplay(
                        endOfDayData.totaldeliveredamount,
                      ),
                    ),
                    KForms.lefRightLabel(
                      'Cash : ',
                      Helperfunctions.formatDoubleAmountForDisplay(
                        endOfDayData.cashamount,
                      ),
                      withLeftIndent: true,
                    ),
                    KForms.lefRightLabel(
                    ...
                    KForms.lefRightLabel(
                      ...
                      Helperfunctions.formatDoubleAmountForDisplay(
                        endOfDayData.expectedcashonhand,
                      ),
                    ),
                    ...
                    if (endOfDayData.actualcashonhand != 0) ...[
                      Divider(),
                      KForms.lefRightLabel(
                        'Salesman Cash-On-Hand : ',
                        Helperfunctions.formatDoubleAmountForDisplay(
                          endOfDayData.actualcashonhand,
                        ),
                      ),
                      KForms.lefRightLabel(
                        'Discrepancy : ',
                        Helperfunctions.formatDoubleAmountForDisplay(
                          endOfDayData.discrepancy,
                        ),
                        rightLabelColor: Colors.red,
                      ),
                      KForms.lefRightLabel(
  ...
  void fetchInitialData() async {
    ...
    breakdown =
        await dbBS.getDocumentsBySpecificDate(_selectedDate) ??
        Breakdown.empty();
  ...
  void validateBeforeBreakdown() async {
    if (endOfDayData.pendingstatus > 0) {
      ShowMessage.error(
        context,
        'There should be no transaction that is pending for delivery',
      );
    } else {
      await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              BreakdownPage(breakdown: breakdown!, breakdownID: breakdownID),
        ),
      );
      fetchInitialData();
    }
