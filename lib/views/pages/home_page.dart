...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> prefetchData() async {
    ...
    pendingDeliveryCount = await dbDelivery.getCountPendingDeliveries();
    ...
    KForms.alertDialogConfirm('Logout', 'Are you sure you want to log out?', context, () async {
      try {
        ...
        if (mounted){
          ...
          Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => const AuthPage()),(Route<dynamic> route) => false,); // This removes all previous routes
        }
      } on FirebaseAuthException catch (e) {
        if (mounted) ShowMessage.error(context, e.message ?? 'There was a problem upon signing out');
    ...
    return ListTile(
      ...
      trailing: notifyCount == null || notifyCount == 0 
        ...
        child: Container(
          ...
          height: 20,
          child: Center(
            child: Text(notifyCount.toString(),
    ...
    return UserAccountsDrawerHeader(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('assets/images/profilebackground.jpg',),fit: BoxFit.cover
        ),
      ),
    );
  }
